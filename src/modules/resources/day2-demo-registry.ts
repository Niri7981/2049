...
export function createDay2DemoRegistry() {
  // Day 2 uses a non-routable endpoint and a placeholder payee by design.
  // Payment work must replace both through server-owned configuration.
  return createStaticResourceRegistry({
    endpoint: "https://paid-api.day2.invalid/v1/market-snapshot",
