...
import type { DiscoveryRun } from "@/modules/agent/discovery-runtime";
...
export function DiscoveryDemo() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const body = (await response.json()) as DiscoveryRun | { error?: string };
  ...
  return (
    <main>
      <header className="hero">
        <p className="eyebrow">Discovery · Capability Discovery</p>
          ...
          <aside className="resource-panel" aria-labelledby="resource-heading">
            ...
            {resource ? (
              <>
                ...
                <div className="stop-notice">资源发现到此结束 · No payment</div>
              </>
            ) : (
